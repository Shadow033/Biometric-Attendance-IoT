...
//Declaration for Sh1106 display connected using software I2C
...
const char *ssid = "Shadow";  //ENTER YOUR WIFI SETTINGS
...
void SendFingerprintID( int finger ){
 ...
 Serial.println("httpCode"); Serial.println(httpCode);   //Print HTTP return code
  Serial.println("payload"); Serial.println(payload);    //Print request response payload
  Serial.println("postData"); Serial.println(postData);   //Post Data
 Serial.println("finger"); Serial.println(finger);     //Print fingerprint ID
